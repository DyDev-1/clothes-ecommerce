<template>
   <div class="px-5 desktop:container ">
    <div class="breadcrumbs text-sm pb-10">
      <ul>
  ...
  <div class="flex flex-col desktop:flex-row gap-3">
   ...
   <div class="border border-gray rounded-2xl w-full desktop:w-[35%]  h-[80%] p-5 ">
    ...
    <input
      type="text"
      class="rounded-[62px] bg-gray px-10 outline-none py-3 w-full"
