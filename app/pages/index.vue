...
<template>
  <main>
    ...
    <section class="py-2">
      ...
      >
        <SwiperSlide v-for="slide in 10" :key="slide">
          <div class="bg-gray  px-5 desktop:container flex flex-col md:flex-row gap-6">
            <!-- Text Section -->
            <div class="w-full md:w-1/3 flex flex-col justify-center">
              <p
                class="font-Poppins text-4xl md:text-6xl font-bold leading-tight"
              >
            ...
            <!-- Image Section -->
            <div class="w-full md:w-1/2 flex justify-center ml-auto">
              <NuxtImg
    ...
    <!-- NEW ARRIVALS -->
    <section class="px-5 desktop:container py-20">
      <h1
    ...
    <!-- TOP SELLING -->
    <section class="px-5 desktop:container py-20 border-b-gray">
      <h1
        class="font-Poppins text-4xl md:text-6xl leading-tight text-center py-4 font-extrabold"
      >
        TOP SELLING
    ...
    <section class="px-5 desktop:container  py-20">
      <div class="bg-gray rounded-3xl text-center py-20">
        <h1
